...
import { VehicleRequestTypeList } from './VehicleRequestTypeList';
...
describe('VehicleRequestTypeList', () => {
  it('should render without crashing', () => {
    const { container } = render(<VehicleRequestTypeList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<VehicleRequestTypeList />, { wrapper });
    expect(screen.getByText('VehicleRequestType')).toBeDefined();
  });

  it('should have create button', () => {
    render(<VehicleRequestTypeList />, { wrapper });
    expect(screen.getByText('+ Create VehicleRequestType')).toBeDefined();
  });
