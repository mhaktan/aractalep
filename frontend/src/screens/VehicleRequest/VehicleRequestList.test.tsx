...
describe('VehicleRequestList', () => {
  it('should render without crashing', () => {
    const { container } = render(<VehicleRequestList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<VehicleRequestList />, { wrapper });
    expect(screen.getByText('VehicleRequest')).toBeDefined();
  });

  it('should have create button', () => {
    render(<VehicleRequestList />, { wrapper });
    expect(screen.getByText('+ Create VehicleRequest')).toBeDefined();
  });
