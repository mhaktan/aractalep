                ...
                switch (node.Type)
                {
                    ...
                    case "approval":
                        ...
                        try
                        {
                            ...
                            var appServiceType = System.Type.GetType("aractalep.Approvals.IApprovalAppService, aractalep.Application")
                                ?? throw new InvalidOperationException("IApprovalAppService type not found in aractalep.Application assembly");
                            ...
                            var submitInputType = System.Type.GetType("aractalep.Approvals.Dto.SubmitApprovalInput, aractalep.Application")!;
